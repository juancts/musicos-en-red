...
export const perfilSelect =
  "id, nombre, email, tipo, ciudad, codigo_postal, provincia, bio, avatar_url, instrumento, busca, generos, disponible, direccion, telefono, contacto_mensajes, contacto_email_publico, contacto_telefono_publico, notificar_mensajes_email, precio_hora, capacidad_max, equipamiento, horario, servicios, comodidades, modelos_alquiler, packs_unlocked, precio_locked_mensual, created_at";
