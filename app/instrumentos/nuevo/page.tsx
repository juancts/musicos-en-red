...
export default function NuevoAnuncioPage() {
  ...
  if (!userId) {
    return (
      <div className="max-w-5xl mx-auto px-4 py-24 text-center">
        <h1 className="text-xl font-semibold text-gray-900">Inicia sesión para publicar</h1>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <h1 className="text-2xl font-semibold text-gray-900 mb-2">Publicar instrumento</h1>
