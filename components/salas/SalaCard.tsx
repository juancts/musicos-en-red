...
export default function SalaCard({ sala, cerca, esSuscriptor }: Props) {
  ...
  return (
    <Link
      ...
      className="group block border border-gray-100 dark:border-gray-800 rounded-2xl p-4 transition-all hover:border-emerald-200 hover:bg-emerald-50/40 hover:dark:bg-emerald-950/40"
    >
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-medium text-gray-900 dark:text-gray-50 text-sm truncate group-hover:text-emerald-700">
        ...
        {cerca && (
          <span className="flex-shrink-0 text-xs bg-emerald-100 dark:bg-emerald-900 text-emerald-700 px-2 py-0.5 rounded-full font-medium">
            Cerca
          </span>
        )}
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-2">
        {numSalas > 0 && (
          <span className="text-xs text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 px-2.5 py-0.5 rounded-full">
